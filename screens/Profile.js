        ...
        <View style={styles.groupView}>
          ...
          <View style={styles.view1}>
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/22-iconsfilledgrid-copy-91.png")}
            />
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("AppointmentOngoing")}
          >
            <Image
          ...
          <View style={styles.view2}>
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/22-iconsfilledgrid-copy-34.png")}
            />
